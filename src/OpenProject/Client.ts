...
import { OpenProjectInstance } from "../config/Config";
...
const log = new Logger("OpenProjectClient");

/**
 * A OpenProject project used inside a URL may either be the ID of the project, or the encoded path of the project.
 */
...
export class OpenProjectClient {
    ...
    public static splitUrlIntoParts(instances: {[name: string]: OpenProjectInstance}, url: string): [string, string[]]|null {
    ...
    public async getProjectAccessLevel(id: ProjectId): Promise<AccessLevel> {
        try {
            ...
            // https://docs.OpenProject.com/ee/api/members.html#get-a-member-of-a-group-or-project-including-inherited-and-invited-members
